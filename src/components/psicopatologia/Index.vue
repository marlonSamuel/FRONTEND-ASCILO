      ...
      create(){
          ...
          .then(r=>{
            self.loading = false;
              ...
              self.$toastr.success('psicopatología creada con éxito', 'Mensaje');
              self.getAll()
          })
          .catch(e=>{
      ...
      update(){
          ...
          .then(r=>{
            self.loading = false;
              ...
              self.$toastr.success('psicopatología actualizada con éxito', 'Mensaje');      
              self.getAll()
          })
          .catch(e=>{
      ...
      remove(){
          ...
          .then(r=>{
            self.loading = false;
              ...
              self.$toastr.success('psicopatología eliminada con éxito', 'Mensaje');
              self.getAll()
          })
          .catch(e=>{
