      ...
      create(){
          ...
          .then(r=>{
            self.loading = false;
              ...
              self.$toastr.success('Examen creada con éxito', 'Mensaje');
              self.getAll()
          })
          .catch(e=>{
      ...
      update(){
          ...
          .then(r=>{
            self.loading = false;
              ...
              self.$toastr.success('Examen actualizada con éxito', 'Mensaje');      
              self.getAll()
          })
          .catch(e=>{
      ...
      remove(){
          ...
          .then(r=>{
            self.loading = false;
              ...
              self.$toastr.success('Examen eliminada con éxito', 'Mensaje');
              self.getAll()
          })
          .catch(e=>{
